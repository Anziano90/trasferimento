...
@Entity
@Table(name = "esami_da_convalidare", schema = "trasferimento", catalog = "")
public class EsamiDaConvalidareEntity {
    ...
    public boolean equals(Object o) {
        ...
        EsamiDaConvalidareEntity that = (EsamiDaConvalidareEntity) o;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (idModulo != null ? idModulo.hashCode() : 0);
